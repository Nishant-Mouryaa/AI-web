...
import './HowItWorksCard.css'; // Import custom CSS for HowItWorksCard

const HowItWorksCard = ({ icon, title, description, moreInfo, delay }) => {
  ...
  return (
    ...
    >
      <Card
        ...
        aria-controls={`howitworks-collapse-${title}`}
      ...
      >
        <Card.Body>
          ...
          >
            <div className="mb-3 text-success howitworks-icon">{icon}</div>
          </OverlayTrigger>
